...
public class InternalRecipeBlasting extends InternalRecipeCooking {
    ...
    public InternalRecipeBlasting(MinecraftKey key, String group, RecipeItemStack input, ItemStack result, float exp, int cookTime, ArrayList<Options> options) {
    ...
    public IRecipe<?> getVanillaRecipe() {
        return new net.minecraft.server.v1_16_R3.RecipeBlasting(key, group, input, output, experience, cookingTime);
    }
