...
public class RecipeSmelting extends AbstractCooking implements CraftRecipe, CustomRecipe {
    ...
    public RecipeSmelting(NamespacedKey key, ItemStack result, Material input, float exp, int cookingTime, Map<String, Object> options) {
        super(options);
        this.bukkitRecipe = new FurnaceRecipe(key, result, input, exp, cookingTime);
    }

    public RecipeSmelting(NamespacedKey key, ItemStack result, RecipeChoice input, float exp, int cookingTime, Map<String, Object> options) {
        super(options);
        this.bukkitRecipe = new FurnaceRecipe(key, result, input, exp, cookingTime);
    }
